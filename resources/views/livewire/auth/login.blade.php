...
{{--                        <input wire:model.lazy="remember_token" id="remember_token" type="checkbox" class="form-checkbox w-4 h-4 text-indigo-600 transition duration-150 ease-in-out" />--}}
{{--                        <label for="remember_token" class="block ml-2 text-sm text-gray-900 leading-5">--}}
{{--                            Remember--}}
{{--                        </label>--}}
{{--                    </div>--}}
